    ...
    <template v-slot:default>
      ...
      <tbody>
        ...
        >
          ...
          <td> 
          <app-topup :profile="item" v-on:updatebalance="updatebalance(userid,latestbalance)"></app-topup>
          <td>   
...
export default {
  ...
  methods: {
    ...
    updatebalance(userid,latestbalance){
      console.log(userid,latestbalance)
    }
  },
  computed: {
    loadprofiles() {
