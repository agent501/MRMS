  ...
  <div class="mx-10" style="max-width:1800px">
    ...
    <div>
      ...
      <v-card class="d-flex flex-wrap mx-auto text-center" width="1200" flat tile>
        <v-card v-for="n in 12" :key="n" class="pa-2" width="120" height="145" outlined tile>
          <v-img height="100" width="100" src="https://cdn.vuetifyjs.com/images/cards/store.jpg"></v-img>Flex item
        </v-card>
      </v-card>
    </div>
  </div>
