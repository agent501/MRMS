    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="6">
        ...
        <v-card class="text-capitalize" outlined>
          ...
          <v-col>
            <app-register-product :productid="product.id"></app-register-product>
             <v-btn text block @click.stop="investdialog = true" class="blue white--text" raised>
                Invest
              </v-btn>
             <v-dialog v-model="investdialog" max-width="600">
                <v-card>
                  <v-card-title class="headline">You about to invest this product that is RM{{product.investmentperunit * 5}} </v-card-title>
                  <br>
                  <v-card-actions>
                    <!-- <v-spacer></v-spacer> -->
                    ...
                    <v-btn
                      color="green darken-1"
                      raised
                      @click="investProduct(product.id,product.investmentperunit)"
                      type="submit"
                    >Yes</v-btn>

                    <v-btn color="red darken-1" raised @click="investdialog = false">No</v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
          </v-col>
