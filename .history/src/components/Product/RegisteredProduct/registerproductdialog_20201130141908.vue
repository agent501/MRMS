         ...
         <v-container>
          <v-layout row wrap>
            <v-flex xs12>
              ...
              <v-card-title v-else>You about to invest this product that total value RM{{product2 * 5}}</v-card-title>
            </v-flex>
          </v-layout>
          <v-divider></v-divider>
          <v-layout row wrap>
...
export default {
  ...
  methods: {
    onAgree() {
        ...
        this.$store.dispatch('registerUserForMeetup',this.product1)
