    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="6">
        ...
        <v-card class="text-capitalize" outlined>
          ...
          <v-col>
             <v-btn text block @click.stop="investdialog = false" class="blue white--text" raised>
                Invest
              </v-btn>
             <v-dialog v-model="investdialog" max-width="500">
                <v-card>
                  <v-card-title class="headline">You about to invest this product that is RM{{product.investmentperunit * 5}} per block</v-card-title>
