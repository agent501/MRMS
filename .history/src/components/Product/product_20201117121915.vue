        ...
        <v-card class="text-capitalize" outlined>
          ...
          <v-col>
             <v-btn text block @click.stop="investdialog = true" class="blue white--text" raised>
                Invest{{product.investmentperunit * 5}}
              </v-btn>
             <v-dialog v-model="investdialog" max-width="500">
                <v-card>
                  <v-card-title class="headline">You about to invest this product that would cost {{product.investmentperunit * 5}} per unit</v-card-title>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn
                      color="green darken-1"
                      raised
                      @click="investProduct(product.id)"
                      type="submit"
                    >Yes</v-btn>
