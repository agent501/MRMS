    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="6">
        <v-card class="text-capitalize" outlined>
          <v-card-title class="text-uppercase font-weight-bold display-1">
            Product details
            <template v-if="userIsCreator" xs12>
              <v-spacer></v-spacer>
          ...
          <!-- <v-list-item>
              <v-list-item-content>current ranking</v-list-item-content>
              <v-list-item-content class="subtitle-1 font-weight-thin"
                >: 3rd</v-list-item-content
              >
            </v-list-item>
            <v-list-item>
              <v-list-item-content>total invested</v-list-item-content>
              <v-list-item-content class="subtitle-1 font-weight-thin"
                >: 20</v-list-item-content
              >
          </v-list-item>-->
          <!-- <v-list-item>
              <v-list-item-content>total earning</v-list-item-content>
              <v-list-item-content class="subtitle-1 font-weight-thin">: RM60</v-list-item-content>
            </v-list-item>

            <v-divider></v-divider>

            <v-list-item>
              <v-list-item-content>total investment</v-list-item-content>
              <v-list-item-content class="subtitle-1 font-weight-thin">: RM180</v-list-item-content>
            </v-list-item>
            <v-list-item>
              <v-list-item-content>total earning</v-list-item-content>
              <v-list-item-content class="subtitle-1 font-weight-thin">: RM240</v-list-item-content>
          </v-list-item>-->
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="6">
        <v-card class="pa-8">
          ...
          <v-card-title md="6" row wrap class="text-center title">Current Status</v-card-title>
          <v-spacer></v-spacer>
          <v-divider></v-divider>
          <v-spacer></v-spacer>
          <br />
          <span v-for="(progress,i) in product.productprogressbar" :key="i">
            <v-col cols="12>{{progress.title}} Batch</v-col>
            <v-col>
              <v-progress-linear
